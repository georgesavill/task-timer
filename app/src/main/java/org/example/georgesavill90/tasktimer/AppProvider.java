...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "org.example.georgesavill90.tasktimer.provider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // eg. content://org.example.georgesavill90.tasktimer.provider/Tasks
...
//                if (recordId >= 0){
//                    returnUri = TimingsContact.Timings.buildTimingsUri(recordId);
//                } else {
//                    throw new android.database.SQLException("Failed to insert into " + uri.toString());
//                }
//                break;
